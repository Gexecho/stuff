...
exec python -O -u "$0" ${1+"$@"}
' '''
# Thx Justin Clarke and gdssecurity com
#
# SQLBrute - multi threaded blind SQL injection bruteforcer
# By Justin Clarke, justin at gdssecurity com
#
# This tool is released under the Reciprocal Public License 1.5
...
# http://www.justinclarke.com/2006/03/using-sqlbrute-to-brute-force-data-from.html
#
